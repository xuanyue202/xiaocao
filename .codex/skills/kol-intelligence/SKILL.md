...
- For hourly `daily_analysis_input_required`, keep stdin open, read
  [semantic-model-routing.md](references/semantic-model-routing.md), and use
  only `config/semantic-analyst.json`.
