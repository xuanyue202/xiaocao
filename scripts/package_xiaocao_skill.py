...
def validate_skill(skill_dir: Path) -> None:
    ...
    required = [
        ...
        *(skill_dir / "references" / name for name in SKILL_REFERENCE_FILES),
        ...
        runtime / "src" / "xiaocao" / "live" / "foundersc_native_broker.py",
        runtime / "src" / "xiaocao" / "live" / "book_b_live_lifecycle.py",
        runtime / "src" / "xiaocao" / "live" / "book_b_live_intraday.py",
        runtime / "src" / "xiaocao" / "live" / "kol_policy.py",
        runtime / "src" / "xiaocao" / "live" / "account_risk.py",
        runtime / "src" / "xiaocao" / "kol" / "trading_context.py",
        runtime / "src" / "xiaocao" / "kol" / "trading_decision.py",
        ...
        runtime / "scripts" / "book_b_live_morning.py",
        runtime / "scripts" / "book_b_live_intraday.py",
...
def smoke_test(runtime_dir: Path) -> None:
    ...
    subprocess.run(
        [
            ...
            "scripts/book_b_live_intraday.py",
            ...
            "src/xiaocao/live/book_b_live_lifecycle.py",
            "src/xiaocao/live/book_b_live_intraday.py",
        ],
        cwd=runtime_dir,
        env=env,
        check=True,
