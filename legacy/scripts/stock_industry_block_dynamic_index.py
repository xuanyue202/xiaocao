...
for current_date in dates:
    ...
    while retries < max_retries:
        ...
        time.sleep(random_sleep_time)
        try:
            response = requests.post('https://p-xcapi.topxlc.com/stock/xiao_cao_industry_block_dynamic_index',
...
pd.DataFrame(content).to_csv('results/xiaocao_industry_block_dynamic_index_0.csv', index=False)
