...
def capture(candidates, client, date_iso, is_live, top_n=3, out=OUT, book="B"):
    ...
    for c in candidates:
        ...
        rec = {
            ...
            "market_guard_required": c.get("market_guard_required"),
            "market_guard_status": c.get("market_guard_status"),
            "trade_status": c.get("trade_status"),
            "market_price": c.get("market_price"),
            "down_price": c.get("down_price"),
            "up_price": c.get("up_price"),
            "market_observed_at": c.get("market_observed_at"),
            "reason": c.get("reason"),
