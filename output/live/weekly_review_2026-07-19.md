...
## 需要你看/确认的事项
- **本地工作区提醒，不是策略判断**：有 56 个本来就 dirty 的可改路径，本周自动化不会碰它们。样例：.codex/automations/xiaocao-daily-eod/automation.toml, .codex/automations/xiaocao-daily-morning/automation.toml, .codex/automations/xiaocao-intraday-monitor-05/automation.toml, .codex/automations/xiaocao-intraday-monitor-1455/automation.toml, .codex/automations/xiaocao-intraday-monitor/automation.toml；另有 51 个。
...
- PYTHONPATH=src .venv/bin/python scripts/weekly_deep_review.py --help: PASS
- PYTHONPATH=src .venv/bin/python -m pytest tests/test_weekly_deep_review.py tests/test_flywheel_sweep.py -q: PASS (16 passed)
...
```json
{
  "scoreboard": {
    ...
    "oldest_untested_age_days": 48,
    "tested_to_pass": 0.1,
    "transcripts_distilled": 32
  },
  "pass_evidence": [],
  "pre_existing_dirty_count": 62,
